...
class CategorieAbonnementController extends Controller
{
    ...
    {
        $data = CategorieAbonnement::with("abonnements")->where("is_deleted", false)->get();
    ...
    public function store(Request $request)
    {
        ...
        $data = CategorieAbonnement::create([
    ...
    {
        $data = CategorieAbonnement::where("slug",$slug)->first();
    ...
    public function update(Request $request, $slug)
    {
        ...
        $data = CategorieAbonnement::where("slug", $slug)->where("is_deleted",false)->first();
