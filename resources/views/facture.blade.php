    ...
    <div class="container p-2">
        <div class="header fw-bold">
            ...
            <div class="table-container py-21">
                ...
                <div class="column">
                    <p class="text-right1">
                        <span class="fw-bold text-24">FACTURE</span><br />
                        <span class="">
                            N° du facture : {{ $data->reference }} </span><br />
                        <span class="">
                            Date d’émission : {{ date('d/m/Y', strtotime($data->startDate))}} </span><br /><br />
                        <span>À</span><br /><br />
                        <span class="fw-bold">{{ $entreprise->denomination}}</span><br />
                        <span class="">{{"BP: ".$entreprise->boite_postale}}</span><br />
                        <span class="">Tél.: {{ $entreprise->telephone }}</span><br />
                        <span class="">E-mail: {{ $user->email }}</span><br />
                        <span class="">Siège social: {{ $entreprise->situation_geo }}</span><br />
                        <span class="">Forme juridique: {{ $entreprise->forme_juridique }}</span><br />
                        <span class="">IFU: {{ $entreprise->ifu }}</span><br />
                        <span class="">RCCM: {{ $entreprise->rccm }}</span><br />
                        <span class="">Régime d'imposition: {{ $entreprise->regime_imposition }}</span><br />
                    </p>
                </div>
            </div>
        </div>
        <div class="content m-100 position-relative">
            ...
            <div class="table-container">
                ...
                <div class="column bg-primary1 text-right1">
                    <p class="text-right1 text-center">
                        <br>
                        <span class="text-underline">La Gérante</span><br /><br /><br />
                    </p>
                    <p class="text-right1 text-center">
                        <span class="fw-bold">Aoua OUEDRAOGO</span><br />
                    </p>
                </div>
            </div>
        </div>
