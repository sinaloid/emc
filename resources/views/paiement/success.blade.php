        ...
        <div class="row">
            <div class="col-md-5 mx-auto card p-3">
                ...
                <div class="text-center">
                    Votre paiement à reussi <br />
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tempore commodi quo eos, quisquam id
                    quidem deleniti corporis corrupti iusto odio, ad inventore. Nam, inventore aperiam. Consequuntur
                    culpa voluptatum laboriosam quo?
                </div>
                <div class="mt-5 d-flex justify-content-center">
                    <a type="button" href="https://emc-burkina.com/"
                        class="btn btn-secondary d-inline-block pt-2 mx-2">Accueil</a>
                </div>
            </div>
        </div>
    </div>
