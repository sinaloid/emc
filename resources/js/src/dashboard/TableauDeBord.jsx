    ...
    return (
        <>
            ...
            <div className="row row-cols-1 row-cols-md-4">
                <div className="col text-primary">Derniers devis demandés</div>
                <div className="col">Campagnes en cours</div>
                <div className="col">Campagnes en attente de paiement </div>
                <div className="col">Derniers documents</div>
            </div>
